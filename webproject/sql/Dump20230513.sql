...
LOCK TABLES `admin0` WRITE;
/*!40000 ALTER TABLE `admin0` DISABLE KEYS */;
INSERT INTO `admin0` VALUES (1,'yazan@gmail.com','123456');
/*!40000 ALTER TABLE `admin0` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `requests` (
  ...
  `enginpower` int DEFAULT NULL,
  `carorigin` varchar(150) DEFAULT NULL,
  `fultype` varchar(200) DEFAULT NULL,
  `price` int DEFAULT NULL,
  `additionalinformation` varchar(500) DEFAULT NULL,
  `img` blob,
  `addduration` int DEFAULT NULL,
  `advertsiername` varchar(200) DEFAULT NULL,
  `phonenum` int DEFAULT NULL,
...
CREATE TABLE `user0` (
  ...
  `passworddd` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user0` VALUES ('ah@gmail.com','123456'),('ahmad@gmail.com','123456'),('mohmad@gmail.com','123456'),('sal@gmail.com','123456'),('saleem@gmail.com','123456');
...
-- Dump completed on 2023-05-13 17:54:31
