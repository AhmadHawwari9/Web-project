...
<header>
  <div class="head1">
    ...
    <a href="userpage.php" style="font-size: 40px;text-decoration:none;color:white" class="name">AUTOCAR</a>
    <a href="index.php" class="anchor" style="text-decoration:none">log out</a>
    <label class="label1"></label>
    <a href="shopeuser.php" class="anchor" style="right:230px;text-decoration:none ">shope</a>
    <a href="addcaruser.php" class="anchor" style="right:380px;text-decoration:none ">add a car</a>
