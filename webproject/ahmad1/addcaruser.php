...
if ($pic_1) {
    //echo "Connected successfully 11";
} else {
    die("Connection failed: " .$pic_1 );    
}
...
$sql = "INSERT INTO requests (carmodel,year0 , carcolor,enginpower, carorigin ,fultype, price,additionalinformation,img ,addduration,advertsiername, phonenum , city)
 VALUES ('$car_car_model_id',$car_year,'$car_color', $car_motor_power,'$car_car_origin','$car_fuel', $car_price,'$car_description','$pic_1',$car_period,'$car_owner',$car_phone , '$car_city_id')";
// Check connection
$res = $conn->query($sql);
$conn->commit();
...
<header>
  <div class="head1">
    ...
    <a href="userpage.php" style="font-size: 45px" class="name">AUTOCAR</a>
    <a href="index.php" class="anchor">log out</a>
    <label class="label1"></label>
    <a href="shopeuser.php" class="anchor" style="right:230px ">shope</a>
    <a href="addcaruser.php" class="anchor" style="right:380px ">add a car</a>
...
<div class="all_contents" style="position: relative;top: 30px;bottom: 100px" method="post" >
    <table width="100%">
        ...
        <form class="new_car" id="new_car" enctype="multipart/form-data" action="addcaruser.php" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="se2wUE8jFpgEy3ViCr06quVzpR9bXzJ6c3vFFBrcDo5WuGH/zM6wKBE2U2W6irxYR53bpDrzLwU3fV01ZiuWjA==">

            <div class="space_placeholder"></div>

            <table class="list_ads" width="50%">
                <tbody><tr class="section_title">
                    <th width="10%">Adjective</th>c
            ...
            <table class="create_post" width="100%">
                ...
                <tr id="row_15" class="list-row">
                    <td class="center_content" width="25%"><label >image</label></td>
                    <td><input type="file" name="pic_1" id="pic_1" accept="image/*"></td>
               </tr>
            ...
            <div class="space_placeholder"></div>
            <input type="submit" name="addcaruser" value="Add an advertisement" class="btn btn-info btn-sm" data-disable-with="Add an advertisement" style="margin-left: 10px; border-radius: 0.5rem">
            <br>
        </form>
        </tbody>
    </table>
<br>
    <footer class="foot" style="border-top: black solid 2px">
        ...
        <div class="row">
            <div class="column">
                <a  target="_blank" href="Howtoochoosecar.php" style="font-size:20px ;text-decoration: black"><img src="imgs/bmw2.jpg" style="width: 90%"> <p style="position: relative;bottom:0px;padding: 10px">How to choose your car?</p> </a>
            </div>
            <div class="column">
                <a href="electriccars.php" target="_blank" style="font-size: 20px;text-decoration: black"><img src="imgs/electric.webp" style="width:90%"><p style="position: relative;bottom:0px;padding: 10px">Electric cars</p></a>
            </div>
            <div class="column">
                <a href="caraccidants.php" target="_blank" style="font-size: 20px;text-decoration: black"><img src="imgs/Accidents.jpeg" style="width:90%"><p style="position: relative;bottom:0px;padding: 10px;">Reasons why car accidents happen. ...</p></a>
            </div>
        </div>
